...
public class WorldGeneratorBlueGreenDottedOre implements IWorldGenerator {
    @Override
    ...
    public final int attemptsToSpawn = 10;
    public final int yMin = 1;
    public final int yMax = 50;
    private void GenerateOverworld(Random random, int x, int z, World world) {
        this.addOres(ModBlocks.BlueGreenDottedOre, world, random, x, z, veinSizeMin, veinSizeMax, attemptsToSpawn, yMin, yMax);
    }
